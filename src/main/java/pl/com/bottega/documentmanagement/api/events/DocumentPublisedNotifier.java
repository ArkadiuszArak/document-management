 ...
 */
public class DocumentPublisedNotifier implements DocumentListener {

    private MailingFacade mailingFacade;
    private HRSystemFacade hrSystemFacade;

    public DocumentPublisedNotifier(MailingFacade mailingFacade, HRSystemFacade hrSystemFacade) {
