 ...
 */
public class DociumentManagementCommandFactory implements CommandFactory {

    private ApplicationContext applicationContext;

    public DociumentManagementCommandFactory(ApplicationContext applicationContext) {
